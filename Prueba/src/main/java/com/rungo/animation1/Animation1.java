...
public class Animation1 extends javax.swing.JFrame {
    ...
    private void btnStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStartActionPerformed
        ...
        animationThread = new Thread(new Runnable() {
            ...
            public void run() {
                do{
                    if(LAST_X == 0 && LAST_Y < panelCanvas.getWidth()-30){
                        LAST_X += 10;
                    ...
                    else if(LAST_X < panelCanvas.getWidth()-30 && LAST_Y == panelCanvas.getWidth()-30){
                        LAST_Y += 10;
                        g.setColor(Color.RED);
                        g.fillOval(LAST_X, LAST_Y, 30, 30);
                        try {
                    ...
                    else if(LAST_X <= panelCanvas.getWidth()-30 && LAST_Y == 0){
                        LAST_X -= 10;
                        g.setColor(Color.RED);
                        g.fillOval(LAST_X, LAST_Y, 30, 30);
                        try {
                    ...
                    else if(LAST_X == panelCanvas.getWidth()-30 && LAST_Y <= panelCanvas.getHeight()-30){
                        LAST_Y -= 10;
                        g.setColor(Color.RED);
                        g.fillOval(LAST_X, LAST_Y, 30, 30);
                        try {
